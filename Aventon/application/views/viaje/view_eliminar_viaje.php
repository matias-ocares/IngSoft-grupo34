...
<div class="container col-sm-4 text-left" >
          <form method="post" id="id_viaje" action="<?php echo base_url();?>viaje/eliminar/" class="form-signin">
              <input type="hidden" name="id_viaje" value="<?php echo $viaje->id_viaje; ?>">    
              
              <button class="btn btn-lg btn-primary btn-block" type="submit" value="Submit">Eliminar viaje</button>
