<div class="col-sm-8 text-left"> 
    <form id="formAuto" name="formAuto" method="post" action="crear_viaje/crear_viaje/"  class="form-signin">
...
?>" max="<?php echo date("Y-m-d", strtotime("+30 days")); ?>">
    ...
    <?php foreach($groups as $each){ ?>
        <option value="<?php echo $each->num_patente ?>"><?php echo $each-> marca?> <?php echo $each-> modelo?> <?php echo $each-> num_patente?> </option>';
    <?php } ?> 
</select>        
...
<?php endif; ?>
        <button class="btn btn-lg btn-primary btn-block" type="submit" onClick="return validacionViaje();">Crear viaje</button>
