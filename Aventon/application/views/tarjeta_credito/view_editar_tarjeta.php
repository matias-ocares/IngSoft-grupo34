<div class="col-sm-8 text-left"> 
    <form id="formulario2" method="post"  onsubmit="return validar();" action="<?php echo base_url(); ?>tarjeta_credito/actualizar" class="form-signin">
        ...
        <button class="btn btn-lg btn-primary btn-block btn_perfil" type="submit">Actualizar tarjeta</button>
         <!-- AGREGO BOTÓN DE ELIMINAR Y POP UP  -->
        <button type="button" class="btn btn-lg btn-primary btn-block btn_perfil" data-toggle="modal" data-target="#deleteCC">Eliminar tarjeta</button>
    </form>
    
        <!-- CONFIGURO EL MODAL DE CONFIRMACIÓN -->
        <div class="modal fade" id="deleteCC" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="deleteCCFile"> Desea eliminar la tarjeta de crédito?</h3>
                    </div>
                    <div class="modal-body">
                        <p> Recuerde que es necesario tener una tarjeta de crédito registrada, 
                        para poder crear un viaje, o postularse a uno. </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"> Cancelar</button>
                        <a href="<?php echo base_url(); ?>tarjeta_credito/eliminar_cc">
